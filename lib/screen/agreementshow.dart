...
class AgreementAndPolicyShow extends StatefulWidget {
  @override
  _AgreementAndPolicyShowState createState() => _AgreementAndPolicyShowState();
}

class _AgreementAndPolicyShowState extends State<AgreementAndPolicyShow> {
